 ...
 * @author Jay Lee
 */
public class BleBloodSugar_pc extends AppCompatActivity  {
    ...
    //註冊廣播
    private final BleBloodSugar_pc.BluetoothReceiver receiver = new BleBloodSugar_pc.BluetoothReceiver();
    //接收廣播
    private class BluetoothReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (message.equals("Temp")) {
                intent = new Intent(BleBloodSugar_pc.this, BleTemperature.class);
                ...
                intent = new Intent(BleBloodSugar_pc.this, BleBloodPressure.class);
                ...
                intent = new Intent(BleBloodSugar_pc.this, BleBloodSugar_pc.class);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MESSAGE_STATE_CONNECTING:
                    mProcessDialog = ProgressDialog.show(BleBloodSugar_pc.this, null,
                            "搜尋裝置", true);
        ...
        public void onCharacteristicChanged_Notify(BluetoothGatt gatt,
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    BleBloodSugar_pc.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            dimissProcessDialog();
                            getValueBG();
    ...
    private void getSharedPreferencesSettings() {
        ...
        mMacAddress = settings.getString(GlobalVariable.BLE_PAIRED_BG_ADDREES, "");
    ...
    private void getValueBG() {
        ...
        AbstractRecord record = mTaiDocMeter.getStorageDataRecord(0,
            ...
            bgdata=Integer.toString(bgValue);

        mDataField.setText(bgValue+"");
    ...
    //上傳部分
    public void jsonValueup(String value) {
        ...
        JSONObject json = jsonPost.uploadBG(number, value,Longitude,Latitude, info);
                ...
                if (res.equals("true")) {
                    ...
                    new Handler().postDelayed(new Runnable(){
                        public void run() {
                            ...
                            //啓動服務程式ervice
                            final Intent intent = new Intent(BleBloodSugar_pc.this, ServiceBluetoothSearch.class);
                            startService(intent);
    ...
    private void main_tab3_DBSave() {
        ...
        SQLite SQLite = new SQLite(BleBloodSugar_pc.this);
